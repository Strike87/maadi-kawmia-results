...
export function Turnstile({ onVerify, onExpire }: TurnstileProps) {
  ...
  return (
    <div className="flex flex-col items-center gap-2 min-h-[65px] w-full">
      <div ref={containerRef} className="flex justify-center w-full max-w-full [&>div]:!max-w-full [&>div]:!overflow-hidden [&>iframe]:!max-w-full [&>iframe]:scale-[0.85] [&>iframe]:origin-center sm:[&>iframe]:scale-100" />
