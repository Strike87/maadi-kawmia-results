...
export function Turnstile({ onVerify, onExpire }: TurnstileProps) {
  ...
  return (
    <div className="flex flex-col items-center gap-2 min-h-[50px] sm:min-h-[65px] w-full">
      <div ref={containerRef} className="flex justify-center w-full [&>div]:!mx-auto [&>iframe]:!mx-auto" />
